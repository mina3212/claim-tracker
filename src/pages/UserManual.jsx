    ...
    <div style={{ fontFamily: "'Nanum Gothic','Malgun Gothic',sans-serif", background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '32px 24px 60px' }}>
        ...
        <Section color="#0891b2">
          ...
          <StepList steps={[
            { title: '고객사 정보 입력', desc: '고객사 그룹(KT/LG/SK 등)을 선택하고, 고객사명을 직접 입력하거나 🔍 버튼으로 검색합니다. 발생일과 접수일도 확인하세요.' },
            { title: '영업담당 부서·담당자 자동 세팅', desc: '로그인 계정의 부서와 이름이 자동으로 채워집니다. 필요 시 직접 변경하세요. (품질기술팀 계정은 부서가 비어있으며, 영업팀·마케팅팀 계정은 해당 부서가 자동 선택됩니다.)' },
            ...
            { title: '품목 유형·품목군 선택', desc: '수입부품/수입완제품/내수부품/내수완제품/자체제작상품 중 하나, 품목군(광분배함류 등)을 선택합니다.' },
            { title: '불량 내용 작성', desc: '어떤 불량이 발생했는지 구체적으로 입력합니다. 고객 신고 내용을 그대로 기재해도 됩니다.' },
            { title: '사진 첨부 (선택)', desc: '접수 시 불량 사진이 있으면 첨부할 수 있습니다. 여러 장 선택 가능하며, 첨부된 사진은 처리결과보고서 "관련 사진" 섹션에도 자동으로 포함됩니다.' },
        ...
        <Section color="#d97706">
          ...
          <StepList steps={[
            ...
            { title: '원인별 상세 내용 작성 (필수)', desc: '각 원인에 대한 분석 내용을 상세히 기술합니다. "➕ 원인 추가" 버튼으로 복수 원인을 작성할 수 있습니다. 예: "LOT 2403-B 생산 시 경화 온도 설정 오류로 접착 불량 발생"' },
            { title: '사진 첨부 (선택)', desc: '원인별 📷 사진 선택 버튼으로 분석 사진을 첨부할 수 있습니다. 첨부된 사진은 처리결과보고서 "관련 사진" 섹션에 자동 포함됩니다.' },
            { title: '"회수품 원인분析 완료" 클릭' },
          ]} />
        ...
        <Section color="#059669">
          ...
          <StepList steps={[
            ...
            { title: '새 탭에서 보고서 확인', desc: '기본 정보 / 처리 경과 / 분析 결과 요약 / 관련 사진이 자동으로 구성됩니다. 첨부 사진이 있으면 "관련 사진" 섹션도 포함됩니다.' },
            { title: '"🖨️ 인쇄 / PDF 저장" 클릭', desc: 'A4 세로 형식으로 출력하거나 PDF로 저장할 수 있습니다.' },
          ]} />
          <InfoBox>
            <strong>관련 사진 섹션:</strong> 각 처리 단계에서 첨부된 사진이 있으면 보고서 "4. 관련 사진"에 단계별로 자동 표시됩니다 (160px 크기). 사진이 없으면 해당 섹션은 나타나지 않습니다.
          </InfoBox>
        </Section>
        ...
        <Section color="#7c3aed">
          ...
          <InfoBox style={{ marginTop: 12 }}>
            <strong>기본정보 수정:</strong> 클레임 상세 페이지에서 "✏️ 수정" 버튼을 누르면 고객사명·품번·품목유형 등을 수정할 수 있습니다. 고객사명 옆 🔍 버튼으로 고객사 검색도 가능합니다.
          </InfoBox>
        ...
        <Section color="#0891b2">
          ...
          <InfoBox>
            <strong>부서별 접근 범위:</strong> 마케팅팀은 해외 접수건만, 영업팀·영업관리팀은 국내 접수건만 표시됩니다. 대시보드와 목록 모두 동일하게 적용됩니다. 품질기술팀·관리자는 전체 건을 볼 수 있습니다.
          </InfoBox>
